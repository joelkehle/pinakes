...
| WP2 | Delivery durability + replication + restore | [#5](https://github.com/joelkehle/pinakes/issues/5) | decision needed | [durability draft](BUSFT_DURABILITY_CONTRACT_DRAFT.md) |
